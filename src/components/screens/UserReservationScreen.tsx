...
export default function UserReservationScreen() {
    ...
    const {startDate, setStartDate, endDate, setEndDate, calUnit, setCalUnit, weekValue, setWeekValue } = useDateContext();
                        ...
                        <div className="p-4 border-b-[1px] border-gray-300 mb-5">
                            ...
                            <div>
                                <div className="grid w-full gap-6 md:grid-cols-3">
                                    <div>
                                        <input type="radio" id="easy" name="paymentMethod" value="easy" className="hidden peer"
                                    ...
                                    <div>
                                        <input type="radio" id="card" name="paymentMethod" value="card" className="hidden peer"
                                    ...
                                    <div>
                                        <input type="radio" id="cash" name="paymentMethod" value="cash" className="hidden peer"
